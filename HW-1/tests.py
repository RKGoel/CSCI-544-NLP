...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_rhyme(self):
        ...
        try: self.assertEqual(self.ld.rhymes("asdf", "chef"), False)
        except: s.append(16)
        try: self.assertEqual(self.ld.rhymes("affinity", "infinity"), False)
        except: s.append(17)
        try: self.assertEqual(self.ld.rhymes("conspire", "fire"), True)
        except: s.append(18)
